        ...
        <ScrollView style={styles.scrollContainer}>
          <View style={styles.wrapper}>
            ...
            <View style={styles.container}>
              ...
              <GradeComponents title="Rhythm Guitar" num="1" />
              <GradeComponents title="Lead Guitar" num="1" />
              <GradeComponents title="Spoken Tests" num="1" />
              <GradeComponents title="Aural Tests" num="1" />
